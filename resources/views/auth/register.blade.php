					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Registrasi Masyarakat</h1>
						...
						<div class="col-lg-6 col-md-6 search-course-left">
							...
							<div class="row details-content">
								<div class="col single-detials">
									...
									<p>
										Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit cupiditate nobis ipsum vel magnam quisquam voluptates provident, aperiam earum nisi? Praesentium quisquam velit in blanditiis earum inventore neque vel adipisci.
									</p>						
								</div>
								<div class="col single-detials">
